...
import { X, Cloud, BookText, Shield, Palette, User, Download } from 'lucide-react'
...
const tabs: { id: Tab; label: string; icon: typeof Cloud }[] = [
  ...
  { id: 'prompts', label: 'Prompts', icon: BookText },
...
export function SettingsPanel({ onClose, initialTab = 'profile' }: SettingsPanelProps) {
  ...
  return (
    <div className="fixed inset-y-0 right-0 w-[480px] max-w-[90vw] bg-white dark:bg-gray-950 border-l shadow-2xl z-50 flex flex-col">
      {/* Header */}
      ...
      <div className="flex-1 overflow-y-auto scrollbar-thin p-4 sm:p-6">
        ...
        {activeTab === 'profile' && (
          <div className="space-y-4">
            {!profileLoaded ? (
              <div className="text-center py-8 text-sm text-gray-400">Cargando perfil...</div>
            ) : profile ? (
              <>
              ...
              <div className="text-center py-8">
                ...
                <p className="text-sm text-gray-500 dark:text-gray-400 mb-4">Aún no has configurado tu perfil profesional.</p>
                <button
